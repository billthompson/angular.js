/**
 * @license AngularJS v1.3.19-local+sha.8633281
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.19-local+sha.8633281/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.19-local+sha.8633281',    // all of these placeholder strings will be replaced by grunt's
